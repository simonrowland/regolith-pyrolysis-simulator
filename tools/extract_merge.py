        ...
        for sid, block in species_map.items():
            ...
            for obs in block.get("observations") or []:
                ...
                entry = {
                    ...
                    "class": obs.get("class"),
                    "class_tag": obs.get("class_tag"),
                    "scientific_class": obs.get("scientific_class"),
                    "status": obs.get("status"),
                    "admission_status": obs.get("admission_status"),
                    "measurement_status": obs.get("measurement_status"),
                    "evidence_kind": obs.get("evidence_kind"),
                    "method_class": obs.get("method_class"),
                    "alpha_role": obs.get("alpha_role"),
                    "type": obs.get("type"),
