...
| SiO (from SiO2 melt) | `0.52*exp(-3685/T_K)`; valid range `1000-1800 K`; uncertainty envelope `[0.003,0.067]` | Wetzel & Gail 2013 A&A 553 A92 DOI 10.1051/0004-6361/201220803; Arrhenius compilation of SiO evaporation coefficient, reaction-rate-limited, cross-checking Gunther 1958, Rocabois 1996, Ferguson & Nuth 2008/2012 | Runtime authority is temperature-dependent alpha_s(T) for source evaporation and wall sticking by microscopic reversibility. The prior `0.04` mid-range value remains provenance only; cold walls below 1000 K are evaluated without clamping and flagged as extrapolated. | pinned T-form (CITED) |
...
| Per-surface deposition / oxidation state | Surface and sticking bands | model / experiment | Fe on cold Cu/SS near `1`; Na `0.5-1.0`; SiO uses `0.52*exp(-3685/T_K)` with extrapolation below `1000 K`; Mg broad `0.04-1.0`; wall `100-400+ deg C`, condenser `50-200+ deg C` | Surface temperature, view factors, sticking, and re-evaporation remain unresolved; SiO sticking is grounded but cold-wall extrapolation remains flagged. |
...
| 11 | Alpha | SiO `alpha=0.52*exp(-3685/T_K)`, valid `1000-1800 K`, envelope `[0.003,0.067]` | literature-pinned | `data/vapor_pressures.yaml::oxide_vapors.SiO.evaporation_alpha`; Wetzel & Gail 2013 DOI 10.1051/0004-6361/201220803 | Very high; SiO dominates non-O2 vapor and cold-wall extrapolation is flagged. |
