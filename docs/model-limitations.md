...
- The builtin K/Na FeO-shuttle reactions (`2K + FeO -> K2O + Fe`, `2Na + FeO -> Na2O + Fe`) are temperature-independent. The `C2A_staged` recipe cools below ~1200 C before C3_K to stay below the approximate K (~1216 C) and Na (~1331 C) FeO crossover temperatures, but the engine does not yet enforce that temperature gate. Temperature-gated ferric/ferrous redox fidelity is future engine work.
