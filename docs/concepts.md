...
- MgO more stable than Al₂O₃ per mol O₂ below the 1471.4 °C JANAF-4th multiphase crossover → Mg can take O from Al₂O₃ (C6 thermite). The 2026-07-11 static recipe holds at 1450 °C, giving +4.153 kJ/mol-O₂ standard-state headroom; operation above the crossover is not part of the static recipe and needs future optimizer-owned local thermite/exotherm evidence. The executable C6-stage residual sweep selected 1450 °C for lunar mare low/high-Ti, lunar highland, and Mars basalt; CI carbonaceous chondrite stays a typed refusal because its staged residual remains below the liquid-fraction workability threshold.
