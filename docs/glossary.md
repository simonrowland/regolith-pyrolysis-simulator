...
**Ellingham** — oxide stability diagram (ΔG of oxidation vs T); drives the species extraction ladder. More negative ΔG = more stable oxide = harder to reduce or volatilise. See [`docs/concepts.md`](concepts.md).
