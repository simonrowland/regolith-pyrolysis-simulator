...
**C6** — Mg thermite reduction (3Mg + Al₂O₃ → 3MgO + 2Al); the static recipe now holds at 1400 °C, below the 1471.4 °C Mg/Al₂O₃ JANAF-4th multiphase crossover with +13.864 kJ/mol-O₂ headroom. Within-noise yield ties break toward margin headroom; CI carbonaceous chondrite remains a typed refusal because its staged residual has no workable liquid-fraction window. Source: `data/setpoints.yaml`. See [`docs/recipe-playbook.md`](recipe-playbook.md).
