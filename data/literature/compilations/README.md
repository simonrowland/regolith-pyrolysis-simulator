...
`robie-hemingway-fisher-1978-usgs-b1452/` contains the complete 400-table census of USGS Bulletin 1452: 274 transcribed tables (4,779 rows in 568 phase-specific records) and 126 explicitly untranscribed OCR stubs; it is assessed reference data and never battery-scored.
