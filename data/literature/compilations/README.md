...
`robie-hemingway-fisher-1978-usgs-b1452/` contains the complete 400-table census of USGS Bulletin 1452: 349 transcribed tables (5,776 rows in 596 phase-specific records) and 51 explicitly untranscribed OCR stubs; it is assessed reference data and never battery-scored.
