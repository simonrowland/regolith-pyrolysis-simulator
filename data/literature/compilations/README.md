...
`robie-hemingway-fisher-1978-usgs-b1452/` contains the complete 400-table census of USGS Bulletin 1452: 374 transcribed tables (6,143 rows in 603 phase-specific records) and 26 explicitly untranscribed OCR stubs; it is assessed reference data and never battery-scored.
