...
`robie-hemingway-fisher-1978-usgs-b1452/` contains the complete 400-table census of USGS Bulletin 1452: 299 transcribed tables (5,123 rows in 574 phase-specific records) and 101 explicitly untranscribed OCR stubs; it is assessed reference data and never battery-scored.
