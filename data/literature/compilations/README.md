...
`robie-hemingway-fisher-1978-usgs-b1452/` contains the complete 400-table census of USGS Bulletin 1452: 324 transcribed tables (5,488 rows in 584 phase-specific records) and 76 explicitly untranscribed OCR stubs; it is assessed reference data and never battery-scored.
