...
def build():
    ...
    manifest = {"schema_version": "literature_compilation_manifest.v1", "source_id": SOURCE_ID,
                ...
                "ocr_policy": {"primary": "pdftotext -layout, separately per PDF page; scratch text outside repository",
                               "second_reading": "Tesseract on rendered printed pages; MinerU tables plus page images for the 111 previously untranscribed records (pass 2)",
                               "numeric_repairs": False, "identity_checks": "detectors only; never correct values",
                               "manual_verification": "atomic weights and constants; pass-2 gap records cross-checked against rendered page images; other records retain automated raster-reading flags"},
