...
427 was visually checked and is blank. Phase boundaries produce 603 JSON
...
tables, 374 are transcribed into 6,143 rows and 577 phase-specific records.
The other 26 tables retain page locators and failure reasons in the `t-852`
...
token (bullets, spaces, and letters are never stripped); 9,585 failing tokens
...
temperature grids split 203 additional phase records, each carrying
