...
427 was visually checked and is blank. Phase boundaries produce 596 JSON
...
tables, 349 are transcribed into 5,776 rows and 545 phase-specific records.
The other 51 tables retain page locators and failure reasons in the `t-852`
...
token (bullets, spaces, and letters are never stripped); 9,055 failing tokens
...
temperature grids split 196 additional phase records, each carrying
