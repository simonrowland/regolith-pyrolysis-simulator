...
function makeHeader(artifact, rows, energy) {
  ...
  return `<header>
    ...
    <div class="meta-chips">
      ...
      ${header.c3_dose && Object.keys(header.c3_dose).length ? `<span class="chip accent">C3 dose ${Object.entries(header.c3_dose).map(([key, value]) => `${esc(key.replace(/_kg$/, ""))} ${kg(value)}`).join(" · ")}</span>` : ""}
    </div>
