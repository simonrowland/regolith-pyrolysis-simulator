...
def test_rows_dormant_legacy_outputs_identical():
    ...
    # The oxide, phosphorus, and MC-4A chunks move this golden intentionally:
    # the six systematic Al/Ca/Cr carriers join the reviewed live projection.
    ...
    # 2026-08-05 MC-4 integration: union foulant projection (see t-535).
