...
_PORTED_PANELS: list[str] = ["p1-fe-redox", "p2-taps", "p3-wall-coating", "p4-stage-purity", "p6-mre", "p7-energy", "p8-cost-rollup", "p9-provenance", "p10-vapor-source", "p12-carrier-pressure", "p13-status-strip", "p14-sankey", "p15-equipment-diagram"]
