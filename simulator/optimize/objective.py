    ...
    *,
    ...
    for definition, raw in zip(definitions, raw_objectives, strict=True):
        ...
        if objective_type(raw) == COMPOSITION_TARGET_TYPE:
            ...
            if definition.metric == "pure_silica_glass_kg":
                evidence[definition.metric] = _silica_objective_evidence(
                    product_classes,
                    value,
                )
...
_SILICA_CAPTURE_PATH = ("pure_silica_glass", "stage_3_capture_kg")
...
def _energy_component_metric(metric: str) -> str | None:
    aliases = {
        ...
        "evaporation_thermal_energy_kWh": "evaporation_thermal",
        "energy_evaporation_thermal_kWh": "evaporation_thermal",
...
def _energy_per_product_metric(metric: str) -> str | None:
    aliases = {
        ...
        "evaporation_thermal_energy_per_product_kWh_per_kg": (
            "evaporation_thermal"
        ),
...
def _energy_component_value(
    ...
    *,
    ...
    record_attr = {
        ...
        "evaporation_thermal": "energy_evaporation_thermal_kWh",
